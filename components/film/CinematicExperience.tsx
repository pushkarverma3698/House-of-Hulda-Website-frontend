...
export function CinematicExperience() {
  ...
  useEffect(() => {
    // Choreograph DOM elements to fade in/out based on scroll
  ...
  return (
    <main ref={containerRef} className="relative bg-transparent text-cream font-body selection:bg-amber selection:text-ink">
      ...
      <CinematicScrubber videoSrc="/videos/mist_loop.mp4" />
      ...
      {/* Spacing for Apple-tier scroll pacing */}
      <div className="relative z-10 pointer-events-none flex flex-col gap-[100vh]">

        {/* L-01 */}
        <section className="cine-section relative min-h-screen flex flex-col justify-center items-start px-8 md:px-24 pt-[30vh]">
          <div className="story-scrim relative space-y-5 max-w-2xl pointer-events-auto">
            ...
            <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-normal leading-[1.05] text-cream text-glow-amber">
              The road stops<br />at Rumsu.
            </h1>
            <p className="text-cream/90 text-base md:text-lg leading-relaxed max-w-xl text-glow-amber">
        ...
        {/* L-02 */}
        <section className="cine-section relative min-h-screen flex flex-col justify-center px-8 md:px-24">
          <div className="story-scrim relative space-y-5 max-w-lg pointer-events-auto">
            <p className="hud-mono text-amber tracking-widest text-[10px]">
              L-02 · 16:15 · THE APPROACH
            </p>
            <h2 className="font-display text-4xl md:text-5xl font-normal leading-tight text-cream text-glow-amber">
              Built like a fortress.<br />Smells like pine.
            </h2>
            <p className="text-cream/80 text-base leading-relaxed text-glow-amber">
            ...
            <button 
              ...
              className="mt-6 px-6 py-3 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-xs hud-mono tracking-widest transition-all uppercase pointer-events-auto shadow-xl"
            >
        ...
        {/* L-03 */}
        <section className="cine-section relative min-h-screen flex flex-col justify-center items-end text-right px-8 md:px-24">
          <div className="story-scrim relative space-y-5 max-w-lg pointer-events-auto">
            <p className="hud-mono text-amber tracking-widest text-[10px]">
        ...
        {/* L-07 Celestial Registry */}
        <section className="cine-section relative min-h-screen flex flex-col justify-center px-6 md:px-16 max-w-6xl mx-auto">
          <div className="story-scrim space-y-6 bg-ink/[0.65] p-6 md:p-10 rounded-2xl backdrop-blur-xl border border-white/[0.07] shadow-2xl pointer-events-auto">
        ...
        {/* L-08 Marketplace */}
        <section className="cine-section relative min-h-screen flex flex-col justify-center px-6 md:px-16 max-w-6xl mx-auto">
          <div className="story-scrim space-y-4 bg-ink/[0.70] p-8 md:p-12 rounded-2xl backdrop-blur-xl border border-white/[0.06] pointer-events-auto">
            <p className="hud-mono text-amber tracking-widest text-[10px]">
        ...
        {/* L-09 Invitation */}
        <section className="cine-section relative h-screen flex flex-col justify-center items-center px-8 text-center pb-[20vh]">
          <div className="story-scrim relative space-y-7 max-w-xl pointer-events-auto">
            <p className="hud-mono text-amber tracking-widest text-[10px]">
            ...
            <Link
              href="/book"
              scroll={false}
              className="px-10 py-4 rounded-full bg-amber/10 border border-amber/30 text-amber hover:bg-amber/20 hover:border-amber/60 hud-mono tracking-widest transition-all shadow-[0_0_15px_rgba(217,154,78,0.15)] text-xs uppercase font-bold inline-block"
            >
              Reserve The Stay
            </Link>
          </div>
